<html>
    <head>
        ...
        <title>Exercice 4 de la partie 3 en PHP</title>
    </head>
    <body>
        <!--Mise en place d'une balise p pour mettre le script php-->
        <p>
            <?php
// Déclaration de d'une variable initialisée à 1 
            $number = 1;
// Introduction de la condition avec la structure while
            while ($number <= 10) {
                // Instruction : afficher la valeur
                echo ' ' . $number;
                ?>
                <!--Il faut sortir du php pour inclure la balise html br-->            
                <br>
                <?php
                // Incrémenter la variable de la moitié de sa valeur
