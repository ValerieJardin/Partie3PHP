<html>
    <head>
        ...
        <title>Exercice 5 de la partie 3 en PHP</title>
    </head>
    <body>
        <!--Mise en place d'une balise p pour mettre le script php-->
        <p>
            <?php
// Déclaration d'une variable repeat initialisée à 1 dans une boucle for et incrémentation
            for ($repeat = 1; $repeat <= 15; $repeat++) {
                ?>
                <br>
                <?php
                // Affichage de la variable suivie d'un message
                echo $repeat . ' On y arrive presque';
            }
            ?> 
        </p>
